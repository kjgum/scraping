...
var options = {
  url: 'http://www.cram.com/flashcards/sat-200-vocabulary-words-with-definitions-and-sample-sentences-361450'
};
...
request(options, function(error, response, html) {
  ...
  $('tbody').each(function(i, element) {
    ...
    // Save the title text
    var title = $div.children('front_text.card_text').text();
